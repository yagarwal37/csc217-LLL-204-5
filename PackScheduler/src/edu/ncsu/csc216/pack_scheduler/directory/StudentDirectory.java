...
public class StudentDirectory {
	...
	/** Sorted list of students in the directory */
	 ...
	 * from the given file, Throws an IllegalArgumentException if the file cannot be found.
	 ...
	 * @throws IllegalArgumentException if the passwords are invalid or if they do not match. 
	 */
	 ...
	 * @throws IllegalArgumentException if it is unable to write to given file
	 */
	...
	/**
	 * Returns a Student object corresponding to the student's
	 * unique unity id.
	 * 
	 * @param id of the Student to return
	 * @return Student object corresponding to given id
	 */
