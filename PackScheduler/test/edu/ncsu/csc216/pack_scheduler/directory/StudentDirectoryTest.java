...
public class StudentDirectoryTest {
	...
	public void testGetStudentById() {
		...
		//Construct an expected student and compare it with the return
		Student exp1 = new Student("Zahir", "King", "zking", 
				"orci.Donec@ametmassaQuisque.com", "MMlS+rEiw/l1nwKm2Vw3WLJGtP7iOZV7LU/uRuJhcMQ=", 15);
		Student act1 = sd.getStudentById("zking");
		assertEquals(exp1, act1);

		Student exp2 = new Student("Raymond", "Brennan", "rbrennan", "litora.torquent@pellentesquemassalobortis.ca",
				"MMlS+rEiw/l1nwKm2Vw3WLJGtP7iOZV7LU/uRuJhcMQ=", 12); 
		Student act2 = sd.getStudentById("rbrennan");
		assertEquals(exp2, act2);
	
		Student exp3 = new Student("Dylan", "Nolan", "dnolan", "placerat.Cras.dictum@dictum.net",
				"MMlS+rEiw/l1nwKm2Vw3WLJGtP7iOZV7LU/uRuJhcMQ=", 5);
		Student act3 = sd.getStudentById("dnolan");
	...
	public void testAddStudent() {
		...
		sd2.addStudent(FIRST_NAME, LAST_NAME, ID, EMAIL, PASSWORD, PASSWORD, 19);
		...
		assertEquals("Invalid password", e1.getMessage(), "Incorrect exception thrown with adding student");
		
		Exception e2 = assertThrows(IllegalArgumentException.class,
				() -> sd.addStudent(FIRST_NAME, LAST_NAME, ID, EMAIL, "", PASSWORD, MAX_CREDITS));
		assertEquals("Invalid password", e2.getMessage(), "Incorrect exception thrown with adding student");
		
		Exception e3 = assertThrows(IllegalArgumentException.class,
				() -> sd.addStudent(FIRST_NAME, LAST_NAME, ID, EMAIL, PASSWORD, null, MAX_CREDITS));
		assertEquals("Invalid password", e3.getMessage(), "Incorrect exception thrown with adding student");
		
		Exception e4 = assertThrows(IllegalArgumentException.class,
				() -> sd.addStudent(FIRST_NAME, LAST_NAME, ID, EMAIL, PASSWORD, "", MAX_CREDITS));
		assertEquals("Invalid password", e4.getMessage(), "Incorrect exception thrown with adding student");
		
		Exception e5 = assertThrows(IllegalArgumentException.class,
				() -> sd.addStudent(FIRST_NAME, LAST_NAME, ID, EMAIL, PASSWORD, "Password", MAX_CREDITS));
		assertEquals("Passwords do not match", e5.getMessage(), "Incorrect exception thrown with adding student");
	}
